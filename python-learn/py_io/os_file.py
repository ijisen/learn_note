...
# 文件重命名 可带路径
# os.rename('./demo.txt', 'write.txt')
# os.rename('demo.txt', 'write.txt')

# 目录打印
# ['dd', 'os_file.py', 'readme.txt', 'read_file.py', 'read_str_io.py', 'write.txt', 'write_file.py', '_test.py']
log(os.listdir('.'))
# ['t_01.txt']
log(os.listdir('./dd'))
# ['dd']
log([x for x in os.listdir('.') if os.path.isdir(x)])